<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" Codebehind="ITEM.aspx.cs" Inherits="NewSM1.ITEM"  %>
        ...
        <ContentTemplate>
            <div class="container-fluid" style="width: 100%; margin-top: 10px; text-align:center">
                <div class="row" style="margin-top:0px;text-align:left">
                  <div class="col-lg-12">
                    <h3 class="card-header"><i class="fa fa-truck"></i>  Product Details</h3>
                  </div>
                </div>
                <div class="row" style="margin-top:10px">
                    <div class="col-md-2 offset-4">
                        <asp:TextBox ID="txtSearchCode" runat="server" CssClass="form-control" placeholder="Product code"></asp:TextBox>
                    </div>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtSearchName" runat="server"  CssClass="form-control" placeholder="Product Name"></asp:TextBox>
                    </div>
                ...
                <div>
                    <telerik:RadGrid ID="radData" runat="server" class="table-responsive" RenderMode="Auto" Skin="Bootstrap" AllowPaging="false" OnNeedDataSource="radData_NeedDataSource" AutoGenerateColumns="False" OnItemCommand="radData_ItemCommand" Width="100%" Style="overflow: auto" GroupPanelPosition="Top" EnableAriaSupport="True" PageSize="9" Visible="False">
                        ...
                        <MasterTableView CommandItemDisplay="Top">
                            ...
                            <Columns>
                                <telerik:GridBoundColumn DataField="ITEM_CODE" FilterControlAltText="Filter id column" HeaderText="CODE" UniqueName="ITEM_CODE">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="ITEM_NAME" FilterControlAltText="Filter ID column" HeaderText="NAME" ReadOnly="True" UniqueName="ITEM_NAME">
                                    <ItemStyle HorizontalAlign="Left" />
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="ITEM_MOLECULE" FilterControlAltText="Filter name column" HeaderText="MOLECULE" UniqueName="ITEM_MOLECULE">
                                    <ItemStyle HorizontalAlign="Left" />
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="SEQ" FilterControlAltText="Filter name column" HeaderText="SEQ" UniqueName="SEQ">
                                    <ItemStyle HorizontalAlign="Left" />
                                </telerik:GridBoundColumn>
                        ...
                        <ContentTemplate>
                            <div class="modal-content modal-lg">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <!-- Full Name -->
                                        <label for="full_name_id" class="control-label">Molecule</label>
                                        <asp:TextBox ID="txtMolecule" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                    <div class="form-group">
                                        <!-- Full Name -->
                                        <label for="full_name_id" class="control-label">SEQ</label>
